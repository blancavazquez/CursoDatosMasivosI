...
val data = sc.textFile("/datasets/wiki-clickstream/part-00009-tid-6420220128212743732-2b3eaab5-6f45-4aff-b488-94083a873664-46-1-c000.snappy.parquet") //creamos un RDD
...
val clickstream = sqlContext.read.parquet("/datasets/wiki-clickstream/part-00001-tid-6420220128212743732-2b3eaab5-6f45-4aff-b488-94083a873664-38-1-c000.snappy.parquet")
...
// MAGIC   WHERE 
// MAGIC     curr_title = 'Ed_Sheeran' AND
...
// MAGIC                              WHERE 
// MAGIC                                    curr_title IN ('Facebook') AND
// MAGIC                                    prev_id IS NOT NULL AND NOT (curr_title = 'Main_Page')
// MAGIC                              ORDER BY n DESC
